<form action="<?php echo Yii::app()->createUrl('kelas/tambahMapel',array('id_kelas'=>$id_kelas))?>" id="pilihanMapelForm" method="POST">
        ...
        <tbody>
            ...
            foreach ($pilihanMapel as $key => $m) {
                ...
                <tr>
                    ...
                    <td><input type="text" class="span3"name="kkm[<?php echo $m['id'] ?>]" value="<?php echo $m['kkm']?>"></td>
                </tr>    
                <?php
            }
            ?>
