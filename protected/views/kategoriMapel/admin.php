...
<div class="span5" style="text-align: left">
    <div class="cms-admin-buttons">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton',array(
                'icon'=>'plus white',
                'label'=>'Tambah Kategori Mapel',
                'url'=>Yii::app()->createUrl('kategoriMapel/create'),
                'type'=>'primary',
...
<?php $this->widget('MyCGridView', array(
	...
	'columns'=>array(
		...
		array(
                    'name'=>'KategoriParent',
                    'value'=>'$data->idKategoriParent->nama',
                ),
		array(
