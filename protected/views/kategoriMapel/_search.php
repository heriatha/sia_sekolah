...
<?php $this->beginWidget('bootstrap.widgets.TbModal', array('id'=>'searchModal')); ?><div class="modal-header">
    ...
    <h3>Advanced Search Kategori Mapel</h3>
</div>
...
<fieldset>
	...
	<div class="control-group">
		<?php echo $form->label($model,'id_kategori_parent',array('class'=>'control-label')); ?>
		<div class="controls"><?php echo $form->textField($model,'id_kategori_parent',array()); ?>
</div>
	</div>
