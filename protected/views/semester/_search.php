...
<?php $this->beginWidget('bootstrap.widgets.TbModal', array('id'=>'searchModal')); ?><div class="modal-header">
    ...
    <h3>Advanced Search Semester</h3>
</div>
...
<fieldset>
	...
	<div class="control-group">
		<?php echo $form->label($model,'semester',array('class'=>'control-label')); ?>
		<div class="controls"><?php echo $form->textField($model,'semester',array('size'=>6,'maxlength'=>6,)); ?>
</div>
	</div>
