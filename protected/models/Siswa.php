...
class Siswa extends MyCActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_tingkat_kelas_diterima' => 'Tingkat Kelas Diterima',
			'jurusan_idJurusan' => 'Jurusan Jurusan',
			'id_tahun_ajaran_diterima' => 'Tahun Ajaran Diterima',
			'nama_ayah' => 'Nama Ayah',
			'alamat_ayah' => 'Alamat Ayah',
			'id_pendidikan_ayah' => 'Pendidikan Ayah',
			'pekerjaan_ayah' => 'Pekerjaan Ayah',
			'penghasilan_ayah' => 'Penghasilan Ayah',
			'nama_ibu' => 'Nama Ibu',
			'alamat_ibu' => 'Alamat Ibu',
			'id_pendidikan_ibu' => 'Pendidikan Ibu',
			'pekerjaan_ibu' => 'Pekerjaan Ibu',
			'penghasilan_ibu' => 'Penghasilan Ibu',
			'nama_wali' => 'Nama Wali',
			'hubungan_dengan_wali' => 'Hubungan Dengan Wali',
			'alamat_wali' => 'Alamat Wali',
			'id_pendidikan_wali' => 'Pendidikan Wali',
