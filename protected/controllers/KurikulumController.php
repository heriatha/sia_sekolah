...
class KurikulumController extends MyController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kurikulum']))
		{
			$model->attributes=$_POST['Kurikulum'];
                        ...
                        $this->notice($is_success,'Kurikulum','create');
			if($is_success){
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Kurikulum']))
		{
			$model->attributes=$_POST['Kurikulum'];
                        $is_success=$model->save();
                        $this->notice($is_success,'Kurikulum','update');
			if($is_success)
				$this->redirect(array('view','id'=>$model->id));
		}
                if($_GET['ajax'])
	...
	public function actionDelete($id)
	{
                ...
                $this->notice($is_success,'Kurikulum','delete');
